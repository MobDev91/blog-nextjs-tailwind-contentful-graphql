...
<div className='grid md:grid-cols-2 gap-10'>
              <div className='image'>
              <Link href={`${baseUrl}${slug}`}><a><Image src={`${postImage.url}`} width={600} height={600}/></a></Link>
              </div>
              ...
              <div>
                <Link href={`${baseUrl}${slug}`}><a className='text-3xl font-bold text-gray-800 hover:text-gray-600 md:text-6xl'>{title}</a></Link>
              </div>
              <div>
